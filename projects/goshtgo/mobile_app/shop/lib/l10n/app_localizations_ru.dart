...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get websiteUnderDevelopmentMessage =>
      'Сайт находится в разработке. Спасибо за ваше терпение.';
  ...
  String get aboutDescription =>
      'Мы создали GoshtGo, чтобы изменить культуру покупки мяса в Узбекистане. Нам важно, чтобы каждая семья получала свежее, халяльное и безопасное мясо, а не компромиссы и разочарования.';
  ...
  String get loginRequired =>
      'Пожалуйста, войдите, чтобы продолжить оформление';
  ...
  String get contactSubtitle =>
      'Мы всегда рады вашим вопросам, предложениям и отзывам. Свяжитесь с нами любым удобным способом — мы ответим как можно скорее.';
  ...
  String get customDeliveryText =>
      'Хотите доставку точно ко времени или за пределы стандартной зоны Ташкента? Свяжитесь с нашим менеджером — мы подстроим маршрут и предложим оптимальное решение.';
  ...
  String get cardPaymentText =>
      'Принимаем UZCARD, HUMO, Uzum Bank, Mastercard, Visa и другие. Списания происходят только после комплектации заказа.\n\n💡 Совет GoshtGo: выбирайте оплату картой или через QR — это быстрее, безопаснее и выгоднее.';
  ...
  String get chilledDeliveryText =>
      'Каждый заказ упаковывается в контейнеры с температурой не выше +4 °C и доставляется в рефрижераторах. Даже в жару мясо остаётся идеально свежим.\n\n💡 GoshtGo гарантирует: от цеха до двери — идеальная свежесть.';
  ...
  String get pleaseLoginFavorite =>
      'Пожалуйста, войдите, чтобы использовать избранное.';
  ...
  String get onboarding_subtitle_1 =>
      'Ваш надёжный маркетплейс свежего мяса и продуктов.';
  ...
  String get onboarding_subtitle_2 =>
      'Присоединяйтесь к нашему сообществу местных продавцов и находите отличные предложения.';
  ...
  String get onboarding_subtitle_3 =>
      'Получайте свои заказы быстро прямо к вашей двери.';
  ...
  String get emptySubtitle =>
      'Попробуйте: \"Быстрый ужин за 30 минут\" или \"Полезные закуски\"';
  ...
  String get notAvailable =>
      'Ни одно из предложенных мяс не доступно в данный момент.';
